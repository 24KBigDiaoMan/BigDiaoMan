...
- (void)setupDefaults {
  self.translatesAutoresizingMaskIntoConstraints = NO;
    self.circles = @[ [UIColor colorWithRed:0.5 green:0.5 blue:0.5 alpha:1],
                      [UIColor colorWithRed:0.1 green:0.3 blue:0.5 alpha:1],
...
- (void)addCircles {
  for (NSUInteger i = 0; i < self.circles.count; i++) {
//    UIColor *color = nil;
...
//    }
      UIColor *color=(UIColor*)[self.circles objectAtIndex:i];
...
- (void)adjustFrame {
  ...
  frame.size.width = (self.circles.count * ((2 * self.radius) + self.internalSpacing)) - self.internalSpacing;
