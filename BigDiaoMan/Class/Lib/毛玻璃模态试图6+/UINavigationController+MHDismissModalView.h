...
/*
 //自定义颜色设置
 MHDismissIgnore *s=[[MHDismissIgnore alloc]initWithViewControllerName:@"SetUpViewController" ignoreBlurEffect:YES ignoreGesture:YES];
 
 [[MHDismissSharedManager sharedDismissManager]installWithCustomColor:RGB(18, 561, 58, 1) withIgnoreObjects:@[s]];
 
 
 
 
 //弹出模态试图设置
 [[MHDismissSharedManager sharedDismissManager]installWithTheme:MHModalThemeCustomBlurColor
